<?php
    ...
    if ($favorite_post_ids) {
        ...
        while ( have_posts() ) : the_post();
            echo "<li class='featured_img_li'><a  href='".get_permalink()."' title='". get_the_title() ."'><span class='favorite_img'> @" . get_the_title() . "</span>";
			echo the_post_thumbnail('thumbnail', array( 'alt' =>$alt ));
			echo "</a> ";
