...
if( isset($_POST['submit']) ){
	...
	if($formok){
		...
		$emailbody = "<p>Instagram Feed Support From Plugin (Premium Version).</p>
		...
		mail("arrowplugins@gmail.com","Instagram Feed Support From Plugin (Premium Version)",$emailbody,$headers);
...
Your message has been sent successfully, Our support team will be in touch with you very soon.</p>
            <form method="post" action="">
                ...
                <label for="telephone">Website URL: </label>
