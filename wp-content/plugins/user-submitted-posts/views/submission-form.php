...
<div id="user-submitted-posts">
	...
	<form id="usp_form" method="post" enctype="multipart/form-data" data-parsley-validate action="">
		...
		<fieldset class="usp-title">
			<label for="user-submitted-title"><?php esc_html_e('Instagirl Username', 'usp'); ?></label>
			<input id="user-submitted-title" name="user-submitted-title" type="text" value="" placeholder="<?php esc_attr_e('@username', 'usp'); ?>"<?php if (usp_check_required('usp_title')) echo $usp_required; ?> class="usp-input">
		</fieldset>
