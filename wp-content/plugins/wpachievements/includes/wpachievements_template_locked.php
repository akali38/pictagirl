...
echo '<center>';
 if(is_user_logged_in()){
  echo '<div id="content_locked">
   ...
   <p style="font-weight:bold;line-height:22px;margin-top:5px;">'. sprintf( __('To unlock this %s you must reach', 'wpachievements'), WPACHIEVEMENTS_POST_TEXT ) .':<br />Rank '.$ii.': '.$locked.'</p>
  </div>';
 } else{
  echo '<div id="content_locked">
   <div id="locked_icon_holder">
