         ...
         if ( !empty($user_achievements) && $user_achievements!='') {
           ...
           foreach( $user_achievements as $user_info ):
             if($user_info->meta_value > 0){
               ...
               if( strtolower($type) == 'points' ){
                 echo '</div><div class="myus_count">'.__('Total Points', 'wpachievements').': '.$user_info->meta_value.'</div>';
               } else{
                 echo '</div><div class="myus_count">'.__('Achievements', 'wpachievements').': '.$user_info->meta_value.'</div>';
               }
